 ...
 *
 */
public class AddHugoEtesterFrontMatter {
...
//			+ "";
	...
	private static String metadataTemplateFOLDER =
			"---\r\n"
			+ "title: \"%1$s\"\r\n"
			+ "topic: \"%2$s\"\r\n"
			+ "subject: \"%3$s\"\r\n"
	...
	private static String metadataTemplatePAGE =
			"---\r\n"
			+ "title: \"%1$s\"\r\n"
			+ "topic: \"%2$s\"\r\n"
			+ "subject: \"%3$s\"\r\n"
	...
	private static boolean replaceMetaDataForIndexFile(File candidateFile) {
		...
		try {
            ...
            if (indexPage) {
                writer.printf(metadataTemplateFOLDER, title, topicSpaces, subjectSpaces, channelSpaces);
                writer.flush();
            } else {
                writer.printf(metadataTemplatePAGE, title, topicSpaces, subjectSpaces, channelSpaces, subject, channel);
                writer.flush();
            }
